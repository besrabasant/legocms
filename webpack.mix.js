...
mix
  ...
  .js("resources/js/legocms-admin.js", "admin/js")
  .js("resources/js/legocms-auth.js", "admin/js");

mix
  .sass("resources/sass/legocms-admin-2.scss", "admin/css")
  .sass("resources/sass/legocms-admin.scss", "admin/css")
...
if (mix.inProduction()) {
  mix.copy(
    "resources/vendor/jquery.min.js",
    "public/assets/admin/js/jquery.js"
  );
} else {
...
if (mix.inProduction()) {
  ...
  mix
    .copyDirectory(
      "public/assets",
      "/media/devs/projects/legocmsdemo/public/assets"
    )
    .browserSync({
      proxy: {
        target: "legocms.test",
