 ...
 * @package  LegoCMS\Commands
 * @author   Basant Besra <besrabasant@gmail.com>
 * @license  MIT https://opensource.org/licenses/MIT
 * @link     https://github.com/besrabasant/legocms/blob/master/src/Commands/CreateSuperAdmin.php
 */
class CreateSuperAdmin extends Command
{
     ...
     * @var string
     */
    protected $signature = 'legocms:superadmin';
    ...
    private function validateEmail($email)
    {
        return $this->validatorFactory->make(
            ['email' => $email],
            ['email' => 'required|email|max:255|unique:' . \config('legocms.users_table')]
        )->passes();
    }
