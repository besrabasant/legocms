...
namespace LegoCMS\Repositories;

use LegoCMS\Models\Contracts\Sortable;
// use LegoCMS\Repositories\Behaviors\HandleBrowsers;
// use LegoCMS\Repositories\Behaviors\HandleDates;
// use LegoCMS\Repositories\Behaviors\HandleFieldsGroups;
// use LegoCMS\Repositories\Behaviors\HandleRepeaters;
 ...
 * @package  LegoCMS\Repositories
 * @author   Basant Besra <besrabasant@gmail.com>
 * @license  MIT https://opensource.org/licenses/MIT
 * @link     https://github.com/besrabasant/legocms/blob/master/src/Repositories/ModuleRepository.php
 */
abstract class ModuleRepository
{
     ...
     * __construct
     *
     * @param null|\LegoCMS\Models\BaseModel $model
     */
    public function __construct($model = null)
    {
        $this->$model = $model ?? \app($this->getModelName());
    }
    ...
    /**
     * Creates model if not exists and returns the model.
     *
    ...
    public function create($fields)
    {
        return DB::transaction(function () use ($fields) {
            ...
            $modelInstance = $this->model->create(Arr::except($fields, $this->getReservedFields()));

            $this->beforeSave($modelInstance, $original_fields);

            $fields = $this->prepareFieldsBeforeSave($modelInstance, $fields);

            $modelInstance->save();

            $this->afterSave($modelInstance, $fields);
    ...
    /**
     * @param \LegoCMS\Models\Model $object
     * @param array $fields
     * @return array
     */
     ...
     * @param \LegoCMS\Models\Model|null $model
     * @return mixed
     */
    protected function getModelRepository($relation, $model = null)
    {
        ...
        return App::make(Config::get('legocms.namespace') . "\\Repositories\\" . \ucfirst($model) . "Repository");
    }
    ...
    {
        return $this->resolveNameSpace() . "Models\\" . \str_replace('Repository', '', \class_basename(static::class));
    }
    ...
    {
        return \str_replace("Repositories\\" . \class_basename(static::class), "", static::class);
    }
}
